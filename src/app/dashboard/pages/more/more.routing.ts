...
export const moreRoutes: Routes = [
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./pages/payment-methods-settings/payment-methods-settings').then((m) => m.PaymentMethodsSettings),
  },
  {
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./pages/accounts-and-permissions/accounts-and-permissions').then((m) => m.AccountsAndPermissions),
  },
  {
    path: 'coupons-and-discount-codes',
    loadComponent: () =>
      import('./pages/coupons-and-discount-codes/coupons-and-discount-codes').then((m) => m.CouponsAndDiscountCodes),
  },
  {
